...
const ProductDetails = ({ product }: ProductDetailsProps) => {
  const { reference, category, company, productShipments, stock, retailPrice, wholesalePrice } = product;
  ...
  return (
    <div className='flex flex-1 flex-col items-start gap-4 xl:flex-row'>
      <div className='flex flex-col gap-6 space-y-1.5'>
        ...
        <ProductDetailItem label='expéditions' value={productShipments.length} />
